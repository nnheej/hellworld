...
class SutdaDeck {
	...
	void registerJokbo() {
		 ...
		 * 1. jokbo(HashMap)에 족보를 저장한다. 두 카드의 값을 문자열로
		 * 붙여서 key로, 점수를 value로 저장한다.
		 */
		String[] key = {"KK","1010","99","88","77",
				"66","55","44","33","22","11","12", 
						"21","14","41","19","91","110",
						"101","410","104","46","64"};
		int[] value= {4000,3100,3090,3080,3070,
				3060,3050,3040,3030,3020,3010,
				2060,2060,2050,2050,2040,2040,
				2030,2030,2020,2020,2010,2010};
		for(int i=0; i<key.length; i++){
			jokbo.put(key[i], value[i]);
		}
	}
